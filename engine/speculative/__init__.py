...
def __getattr__(name: str) -> Any:
    if name in _LAZY_ATTRS:
        import engine.speculative.adaptive as _adaptive
        import engine.speculative.eagle_proposer as _eagle
        import engine.speculative.mtp_proposer as _mtp
        import engine.speculative.verifier as _verifier
