...
compatibility. All logic lives in:
  ...
  - ``compiler.mlir_artifact_serialize``  (Section A: serialization)
  - ``compiler.mlir_artifact_load``       (Section B: weight loading)
  - ``compiler.mlir_artifact_binary``     (Section C: binary generation)
  - ``compiler.mlir_artifact_ir``         (Section D: MLIR IR building)
  - ``compiler.mlir_artifact_parse``      (Section E: text parsing)
...
from compiler.mlir_artifact_binary import (  # noqa: F401
...
from compiler.mlir_artifact_ir import (  # noqa: F401
    _build_mlir_attrs,
...
from compiler.mlir_artifact_load import (  # noqa: F401
    _candidate_names,
    _guess_func,
...
from compiler.mlir_artifact_parse import (  # noqa: F401
    _parse_attr_value,
    _parse_attrs,
    _parse_mlir_op,
    _parse_mlir_text,
...
from compiler.mlir_artifact_serialize import (  # noqa: F401
    _format_attr,
