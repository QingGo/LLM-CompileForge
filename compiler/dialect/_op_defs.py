...
_OP_DEFS: list[_OpDef] = [
    ...
    _OpDef(
        ...
        scalar_kwargs={4: "dropout_p", 5: "is_causal"},
    ),
    ...
    _OpDef("mean", ("mean", "aten.mean.dim", "aten.mean"), scalar_kwargs={2: "keepdim"}),
    ...
    _OpDef("arange", ("aten.arange.start", "aten.arange", "aten.arange.default", "aten.arange.start_step")),
