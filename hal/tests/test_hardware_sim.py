...
class TestHardwareSpec:
    ...
    def test_peak_tflops_for(self) -> None:
        from hal.hardware_spec import ComputeUnit, HardwareSpec
...
class TestRooflineSimulator:
    ...
    def test_roofline_point(self) -> None:
        from verification.roofline_sim import RooflinePoint
    ...
    def test_approximate_op_profile(self) -> None:
        from verification.roofline_sim import approximate_op_profile
...
class TestVirtualDevice:
    def test_create_and_execute(self) -> None:
        from hal.hardware_spec import HardwareSpec
        from hal.virtual_device import VirtualDevice
