...
from python_runtime.server.routes import router
...
def create_engine(
    ...
    from python_runtime.engine.llm_engine import LLMEngine  # concrete import for mypy
    from python_runtime.hal import PyTorchBackend  # type: ignore[attr-defined]
