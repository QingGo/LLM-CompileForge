...
class TestTritonBackend:
    def test_registry_register_and_get(self) -> None:
        from python_runtime.hal.triton_backend import TritonKernelRegistry
    ...
    def test_backend_falls_through_to_pytorch(self) -> None:
        ...
        from python_runtime.hal.triton_backend import TritonBackend
    ...
    def test_backend_triggers_kernel_if_registered(self) -> None:
        from python_runtime.hal.pytorch_backend import PyTorchBackend
        from python_runtime.hal.triton_backend import TritonBackend, TritonKernelRegistry
